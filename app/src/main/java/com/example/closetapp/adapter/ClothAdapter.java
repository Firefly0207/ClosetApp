...
import com.example.closetapp.activity.ClothDetailActivity;
...
public class ClothAdapter extends RecyclerView.Adapter<ClothAdapter.ClothViewHolder> {
    ...
    public ClothAdapter(Context context, List<Cloth> clothList, List<Cloth> selectedClothes) {
    ...
    public void onBindViewHolder(@NonNull ClothViewHolder holder, int position) {
        ...
        // 선택 강조 표시
        if (selectedClothes != null && selectedClothes.contains(cloth)) {
    ...
    public List<Cloth> getSelectedClothes() {
        return selectedClothes;
    }

    public void toggleClothSelection(Cloth cloth) {
        if (selectedClothes == null) return;
